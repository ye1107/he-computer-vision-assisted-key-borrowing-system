...
xml_path = 'D:\\aug\\aug\\aug_small_xml\\'#xml位置
txt = open("D:/v7test/plate_recognition_v7/txt/plate_recognition_v7.txt", 'r')#txt位置
...
for i in range(len(line)):
    file_name = xml_path + (line[i].split('\t')[0])[27:-4] + '.xml'
